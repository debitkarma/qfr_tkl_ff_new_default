...
[1] = LAYOUT_tkl(
                 QK_BOOTLOADER, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_MPLY,  KC_MSTP,  KC_MPRV,  KC_MNXT,  KC_NO,  KC_MUTE, KC_VOLD,  KC_VOLU,             KC_TRNS, KC_NUM, KC_TRNS,
...
layer_state_t layer_state_set_user(layer_state_t state) {
    writePinLow(B7); //repurposing NumLock LED
